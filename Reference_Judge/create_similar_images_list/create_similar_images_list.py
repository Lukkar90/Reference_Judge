...
def create_similar_images_list(source_reference_path, app_reference_path, by_ratio=False):
    """
    ...
    if ext_source:
        ...
        return get_one_ref_pair(source_reference_path, app_reference_path, by_ratio)

    # if source images are dir
    else:

        return get_similar_images_list(source_reference_path, app_reference_path, by_ratio)
